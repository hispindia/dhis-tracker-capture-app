...
.factory('TEIService', function($http, $translate, DHIS2URL, $q, AttributesFactory, CommonUtils, CurrentSelection, DateUtils, NotificationService, TeiAccessApiService) {
    ...
    return {
        ...
        // methods/functions for aggregation
        ...
        getCategoryCombosOptionsDetails: function(){
            ...
            $.ajax({
                ...
                url: DHIS2URL + '/categoryCombos.json?paging=false&fields=id,displayName,code,categoryOptionCombos[id,displayName,code,categoryOptions[id,code,displayName]]',
        ...
        getAggregatedDataValue: function( period, dataSet, de, orgUnit, cc, cp, co, operation ){
            ...
            $.ajax({
                ...
                url: DHIS2URL + '/dataValues.json?paging=false&pe='+period+'&ds='+dataSet+ '&de='+de+ '&ou='+orgUnit+'&cc='+cc +'&cp='+cp +'&co='+co ,
                success: function ( response) {
...
/*
            ...
            return  $http.get( DHIS2URL + '/api/dataValues.json?paging=false&pe='+period+'&ds='+dataSet+ '&de='+de+ '&ou='+orgUnit+'&cc='+cc +'&cp='+cp +'&co='+co )
                .then(function (response) {
        ...
        postAggregatedDataValue: function( period, dataSet, de, orgUnit, cc, cp, co, defaultValue ){
            ...
            $.ajax({
                ...
                contentType: "application/json",
                //data: JSON.stringify(emailParam),
                url: DHIS2URL + '/dataValues.json?paging=false&pe='+period+'&ds='+dataSet+ '&de='+de+ '&ou='+orgUnit+'&cc='+cc +'&cp='+cp +'&co='+co +'&value='+defaultValue,
            ...
            /*
            var tempPostParam = 'paging=false&pe='+period+'&ds='+dataSet+ '&de='+de+ '&ou='+orgUnit+'&cc='+cc +'&cp='+cp +'&co='+co +'&value='+defaultValue;
            return $http.post(DHIS2URL + '/api/dataValues.json/' , tempPostParam )
                .then(function (response) {
                    return response;
                })
                .catch(function (error) {
            ...
            var promise = $http.post( DHIS2URL + '/api/dataValues.json?paging=false&pe='+period+'&ds='+dataSet+ '&de='+de+ '&ou='+orgUnit+'&cc='+cc +'&cp='+cp +'&co='+co +'&value='+defaultValue ).then(function(response){
                return response.data;
            }, function(response){
                return response.data;
            });
