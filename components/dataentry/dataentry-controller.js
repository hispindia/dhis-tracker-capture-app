...
trackerCapture.controller('DataEntryController',
    ...
    else if( $scope.currentEvent.orgUnit === $scope.selectedOrgUnit.id ){
    ...
    // custom change for SAVE-CHILD css for Add Nepali calendar implementation for event-data-entry
